...
class DishDetailViewController: UIViewController {
    ...
    private func addOrder(db: Firestore) {
        ...
        db.collection("orders").addDocument(data: ["id": id, "name": name, "dish-id": dish.id, "dish-name": dish.name, "dish-description": dish.description, "dish-image": dish.image, "dish-calories": dish.calories, "dish-category": dish.category, "dish-popular": dish.popular, "dish-special": dish.special])
    }
